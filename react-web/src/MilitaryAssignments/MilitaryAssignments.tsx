import { useMilitaryAssignments } from './hooks';
import { ExpandableSection, LoadingState, EmptyState, DataField, DataCard } from '../components/Common';
import type { MilitaryUnitData } from './service';

interface MilitaryCardData extends MilitaryUnitData {
  unitId: number;
}

function MilitaryCard({ assignment }: { assignment: MilitaryCardData }) {
...
export function MilitaryAssignments() {
