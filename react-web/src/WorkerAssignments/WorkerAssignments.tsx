import { useWorkerStatus } from './hooks';
import { ExpandableSection, LoadingState, EmptyState, DataField } from '../components/Common';
import type { WorkerAssignment, WorkerAssignmentType } from './service';
...
function AssignmentGroup({ type, workers }: AssignmentGroupProps) {
